# Generated by Django 2.1.1 on 2019-01-22 09:03
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('letter_grade_current', models.CharField(blank=True, choices=[('A', 'A'), ('A-', 'A-'), ('B+', 'B+'), ('B', 'B'), ('B-', 'B-'), ('C+', 'C+'), ('C', 'C'), ('C-', 'C-'), ('D', 'D'), ('F', 'Fail'), ('IC', 'Incomplete Controllable'), ('IU', 'Incomplete Uncontrollable'), ('W', 'Withdrawn'), ('WP', 'Withdrawn Passing'), ('WF', 'Withdrawn Failing'), ('P', 'Passing'), ('N', 'No Grade')], max_length=2, null=True)),
