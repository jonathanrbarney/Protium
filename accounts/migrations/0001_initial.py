    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('gender', models.CharField(blank=True, choices=[('Male', 'Male'), ('Female', 'Female'), ('Attack Helicopter', 'Attack Helicopter')], max_length=1)),
                ('account_type', models.CharField(choices=[('Applicant', 'Applicant'), ('Cadet', 'Cadet'), ('Instructor', 'Instructor'), ('Permanent Party', 'Permanent Party'), ('Coach', 'Coach'), ('Medical Staff', 'Medical Staff'), ('Facilities', 'Facilities'), ('Alumni', 'Alumni'), ('Other', 'Other'), ('None', 'None')], default='None', max_length=30)),
                ('has_attended', models.BooleanField(default=False)),
                ('room_number', models.CharField(blank=True, max_length=7)),
                ('building', models.CharField(blank=True, choices=[('Vandenberg Hall', 'Vandenberg Hall'), ('Sijan Hall', 'Sijan Hall'), ('Fairchild Hall', 'Fairchild Hall'), ('Harmon Hall', 'Harmon Hall'), ('Mitchell Hall', 'Mitchell Hall'), ('Arnold Hall', 'Arnold Hall')], max_length=30)),
                ...
                ('programs', models.ManyToManyField(related_name='cadets', to='academics.Program')),
