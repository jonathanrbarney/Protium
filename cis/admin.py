...
from tritium.forms import Account_Creation_Form, Account_Change_Form
...
class AccountAdmin(UserAdmin):
    ...
    form = Account_Change_Form
    add_form = Account_Creation_Form
...
app_models = apps.get_app_config('cis').get_models()
