    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('period', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='slots', to='schedule.Period')),
            ],
        ),
        migrations.CreateModel(
            name='SCA',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('period', models.ManyToManyField(related_name='sections', to='schedule.Period')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.UUIDField(default=uuid.uuid4, primary_key=True, serialize=False)),
                ('day_type_instance', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='section_instances', to='schedule.Day_Type_Instance')),
